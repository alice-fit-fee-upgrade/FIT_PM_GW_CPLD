...
--               c:/Users/rsmalec/_FPGA/_PW/FIT_PM_GW_CPLD/vivado/fit_pm_dual_range_afe/fit_pm_dual_range_afe.gen/sources_1/bd/design_1/ip/design_1_clk_wiz_0_0/design_1_clk_wiz_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_clk_wiz_0_0_clk_wiz is
  signal clk_20MHz_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_20MHz_n_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_40MHz_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_80MHz_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_in1_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal processor_clk_design_1_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => processor_clk_design_1_clk_wiz_0_0,
      O => processor_clk
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_40MHz_design_1_clk_wiz_0_0,
      O => clk_40MHz
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_20MHz_design_1_clk_wiz_0_0,
      O => clk_20MHz
    );
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_20MHz_n_design_1_clk_wiz_0_0,
      O => clk_20MHz_n
    );
clkout5_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_80MHz_design_1_clk_wiz_0_0,
      O => clk_80MHz
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT0 => processor_clk_design_1_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_40MHz_design_1_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_20MHz_design_1_clk_wiz_0_0,
      CLKOUT2B => clk_20MHz_n_design_1_clk_wiz_0_0,
      CLKOUT3 => NLW_mmcme4_adv_inst_CLKOUT3_UNCONNECTED,
      CLKOUT3B => NLW_mmcme4_adv_inst_CLKOUT3B_UNCONNECTED,
      CLKOUT4 => clk_80MHz_design_1_clk_wiz_0_0,
