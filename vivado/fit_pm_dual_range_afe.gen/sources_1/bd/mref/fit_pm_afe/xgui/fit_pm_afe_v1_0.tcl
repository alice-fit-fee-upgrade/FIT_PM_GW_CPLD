...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DATA_OUT_W" -parent ${Page_0}
...
proc update_PARAM_VALUE.DATA_OUT_W { PARAM_VALUE.DATA_OUT_W } {
	# Procedure called to update DATA_OUT_W when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DATA_OUT_W { PARAM_VALUE.DATA_OUT_W } {
	# Procedure called to validate DATA_OUT_W
	return true
}
...
proc update_MODELPARAM_VALUE.DATA_OUT_W { MODELPARAM_VALUE.DATA_OUT_W PARAM_VALUE.DATA_OUT_W } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DATA_OUT_W}] ${MODELPARAM_VALUE.DATA_OUT_W}
}
